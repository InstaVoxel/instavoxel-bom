...
const sampleBom: FactoryBomData = {
  ...
  parts: [
    { partId: 'P01', dimsMm: { l: 127, w: 89, h: 45 }, weight: 0.34, material: '鋁合金 6061-T6', finish: '黑色陽極氧化', qtyTiers: [1, 5, 10] },
    ...
    { partId: 'P03', dimsMm: { l: 65, w: 52, h: 28 }, weight: 0.24, material: 'ZERODUR', finish: '標準', qtyTiers: [1, 3] },
    { partId: 'P04', dimsMm: { l: 220, w: 180, h: 55 }, weight: 2.18, material: '鋁合金 6061-T6', finish: '標準', qtyTiers: [5, 10, 20] },
    { partId: 'P05', dimsMm: { l: 35, w: 12, h: 8 }, weight: 0.02, material: '不鏽鋼 316L', finish: '電解拋光', qtyTiers: [5, 10, 50] },
    { partId: 'P05', dimsMm: { l: 35, w: 12, h: 8 }, weight: 0.02, material: '不鏽鋼 316L', finish: '電解拋光', qtyTiers: [5, 10, 50] },
    { partId: 'P05', dimsMm: { l: 35, w: 12, h: 8 }, weight: 0.02, material: '不鏽鋼 316L', finish: '電解拋光', qtyTiers: [5, 10, 50] },
    { partId: 'P05', dimsMm: { l: 35, w: 12, h: 8 }, weight: 0.02, material: '不鏽鋼 316L', finish: '電解拋光', qtyTiers: [5, 10, 50] },
  ],
...
export default function FactoryBomDemo() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 0', gap: 16 }}>
      <button
        onClick={handlePrint}
        style={{ padding: '12px 24px', fontSize: 14, fontWeight: 600, cursor: 'pointer',
          background: 'var(--color-primary)', color: 'white', border: 'none', borderRadius: 24 }}
      >
        Download PDF
      </button>
